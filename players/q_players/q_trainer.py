...
class QTrainer:
    def __init__(self):
        self.learning_player = QLearner() # black
        self.opponent_player = GreedyPlayer() # white
        self.test_player = GreedyPlayer() # white
        self.learner_stone = black_stone # TODO: after testing with black, complete to both colors
    ...
    def train(self, iterations=1):
        ...
        print('Training with learner as {}....'.format('X' if self.learner_stone==black_stone else '0'))
        ...
        for iteration in range(iterations):
            ...
            print('{} games have been trained. Current ratio: {}/{}/{}'
            ...
            if iteration % self.train_batch_test == 0 and iteration>0:
                self.test(self.batch_test)
                print('Number of trained states: ', len(self.learning_player.q_table))
            if iteration % self.train_batch_save == 0 and iteration > 0:
    ...
    def test(self, iterations=1):
        ...
        for i in range(iterations):
            ...
            print('---- {} games have been tested for {} learner. Current black-tie-white ratio: {}/{}/{}'
                  .format(count_played_games,
                          'X' if self.learner_stone==black_stone else '0',
                          count_black_wins,
                          count_played_games - count_black_wins - count_white_wins,
                          count_white_wins)
                  )
